...
subresporo = subset(subres, SubExp == 'Choque Térmico')
...
theme = theme_bw(base_size = 15) + 
  theme(legend.position = c(0.8, 0.15),
        ...
        strip.background =element_rect(fill="white")) #Cor do background dos títulos de cada face
...
tiff('imgs/facet/choqporo.tiff', width = 1200, height = 1000, res = 120)
g
dev.off()