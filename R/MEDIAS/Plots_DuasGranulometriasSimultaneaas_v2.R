...
# Legenda puxando pelo vetor não funcionou
...
# Após realizado todo esse pré-processamento, salvar este dataset para poder utilizá-lo em outro Script
# sem perder a formatação e codificação dos tipos de dados
...
ggplot(df, aes(x = Resistencia_Seca, y = Resistencia_Verde, size = Quedas_)) + 
  ...
  scale_shape_manual(values = c(1:14,35:38,17,19)) + 
