...
setwd('C:/Users/vpb/IPT/Francisco Junior Batista Pedrosa (FIPT) - Aglomeraçào de grossos/!Ana/Pelotizacao/Boxplot/R/MEDIAS')
...
subdata = (subset(mydata, 
                  (Experimento %in% c('Resistencia','Quedas') & TS == "1 mm") |
                    (Experimento %in% c('Resistencia','Quedas') & Minerio == "PFM" & Aditivo1 == "BN")))
