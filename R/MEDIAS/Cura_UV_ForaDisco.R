...
g = ggplot(subdata, aes(x = Amostra, y = Valor)) + 
  ...
  # ggtitle(paste("Resistência das pelotas  de granulometria -16 mm + 12,5 mm antes e
  #               após aplicação da resina na forma de gotas sobre a pelota")) +
...
tiff('outputdata/plots/CuraUV/Gotas_B.tiff', units = 'in', width = 10, height = 6, res = 150)
g
dev.off()
