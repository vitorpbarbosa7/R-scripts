...
g = ggplot(subdata, aes(x = Amostra, y = Valor)) + 
  ...
  ggtitle(paste("Resistências das pelotas","verdes","de granulometria",A)) + 
...
tiff('imgs/facet/Parcial_3/Resistencia_Verde_A.tiff', width = dim$w, height = dim$h, res = dim$res)
g
dev.off()
