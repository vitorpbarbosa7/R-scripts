...
subdata = (subset(mydata, 
                  (Experimento == 'Resistência' &
                   SubExp == 'Choque Térmico' & AB == "B" & SubSubExp == "700 °C" &
                   TS == "1 mm") |
                  (Experimento == 'Resistência' &
                   SubExp == 'Choque Térmico' & AB == "B" & SubSubExp == "700 °C" &
...
tiff('imgs/facet/Workshop/Resistencia_ChoqueTermico_700.tiff', width = dim$w, height = dim$h, res = dim$res)
g
dev.off()
