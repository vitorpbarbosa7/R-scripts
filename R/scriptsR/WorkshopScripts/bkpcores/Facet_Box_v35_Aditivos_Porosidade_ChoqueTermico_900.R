...
subdata = (subset(mydata, Experimento == 'Porosidade' &
                   SubExp == 'Choque Térmico' & AB == "B" & SubSubExp == "900 °C" &
                   TS == "1 mm")
                   )
...
cores = c("#33E0FF","#00B0F0","#92D050","#FF0000","#C733FF","#25FF2F","#7030A0","#FF00F0","#FFAD89","#FFC204")
...
tiff('imgs/facet/Workshop/Porosidade_ChoqueTermico_900.tiff', width = dim$w, height = dim$h, res = dim$res)
g
dev.off()
