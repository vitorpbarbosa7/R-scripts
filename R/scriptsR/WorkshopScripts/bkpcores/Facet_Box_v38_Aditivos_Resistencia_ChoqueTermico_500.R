...
subdata = (subset(mydata, 
                  (Experimento == 'Resistência' &
                   SubExp == 'Choque Térmico' & AB == "B" & SubSubExp == "500 °C" &
                   TS == "1 mm") |
                  (Experimento == 'Resistência' &
                   SubExp == 'Choque Térmico' & AB == "B" & SubSubExp == "500 °C" &
...
addlevels = c('0.50% Bentonita  ','0.50% Bentonita 0.04% TPP','0.50% Bentonita 0.04% Arkomon',
              ...
              '0.04% Arkomon  ','0.15% Arkomon  ','0.04% PEO  ','0.12% PEO  ')
...
cores = c('#0289ba',  '#00B0F0',  '#33E0FF',  '#C733FF',  '#841dab',  '#25FF2F',  '#14c91c',  '#FF0000',  '#b50202',  '#f257e9',  '#FF00F0')
