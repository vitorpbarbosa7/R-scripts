...
addlevels = c('0.50% Bentonita  ','0.50% Bentonita 0.04% TPP','0.50% Bentonita 0.04% Arkomon',
              ...
              '0.15% Arkomon  ','0.04% PEO  ','0.12% PEO  ','0.04% Amido  ')

samplelevels = paste("PFNM 1 mm ",addlevels, sep = '')
bentonitalevel = c("PFM 0.50% Bentonita")
...
cores = c('#0289ba',  '#00B0F0',  '#33E0FF',  '#C733FF',  '#841dab',  '#25FF2F',  '#14c91c', '#b50202',  '#f257e9',  '#FF00F0',  '#FFC204'
)
...
tiff('imgs/facet/Workshop/Resistencia_ChoqueTermico_1100.tiff', width = dim$w, height = dim$h, res = dim$res)
g
dev.off()
